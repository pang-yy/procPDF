...
def main():
    ...
    metadataMutuallyExclusiveGroup.add_argument('-r', '--read', action='store_true', help='read pdf metadata')
    metadataMutuallyExclusiveGroup.add_argument('-w', '--write', action='store_true', help='write pdf metadata')
    # argument write
